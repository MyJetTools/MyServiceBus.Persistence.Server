...
namespace MyServiceBus.Persistence.Server
{
    public static class ServicesBinder
    {
        ...
        public static void BindAzureServices(this IServiceCollection sc, SettingsModel settingsModel, AppGlobalFlags appGlobalFlags)
        {
            ...
            sc.BindMessagesPersistentStorage(cloudStorageAccount, appGlobalFlags);
        }
